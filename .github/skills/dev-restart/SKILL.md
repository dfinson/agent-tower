...
- **Build failure**: The server is already stopped. Fix the build error, then re-run the script (or start manually with `tower up --tunnel --password REDACTED_PASSWORD`).

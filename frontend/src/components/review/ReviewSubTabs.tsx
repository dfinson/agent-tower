/**
 * Sub-tab bar for the Review tab — switches between Dashboard, Timeline, and Story.
 */
import { LayoutDashboard, Clock, BookOpen } from "lucide-react";

export type ReviewSubView = "dashboard" | "timeline" | "story";
...
export function ReviewSubTabs({ active, onChange, showTimeline }: ReviewSubTabsProps) {
  return (

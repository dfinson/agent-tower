...
- `TaskLinkRow` (project_id, repo_path, story_node_id, depends_on[], job_id nullable) as a thin correlation row, not a parallel execution model competing with `Job`. (AD-9)
